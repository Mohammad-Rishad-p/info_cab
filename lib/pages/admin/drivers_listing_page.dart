...
class DriversListingPage extends StatefulWidget {
  @override
  State<DriversListingPage> createState() => _DriversListingPageState();
}

class _DriversListingPageState extends State<DriversListingPage> {
  // drivers collection Firebase instance
  final CollectionReference drivers =
      FirebaseFirestore.instance.collection('drivers');

    // function to delete drivers from firestore
    void deleteDriver(docId){
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // using stream builder list drivers from firebase
            Expanded(
              child: StreamBuilder(
                // listing the drivers in alphabetic order
